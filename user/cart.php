        ...
        <ul class="navbar-nav ms-auto me-4">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" data-bs-toggle="dropdown">
                    ...
                    ?>
                    <img src="<?php echo $nav_profile_image; ?>" alt="Profile" class="rounded-circle" style="height: 32px; width: 32px; object-fit: cover;">
                </a>
                ...
                <div class="cart-list w-75">
                    ...
                    ?>
                            <div class="cart-item d-flex align-items-center">
                                <input type="checkbox" name="selected_items[]" value="<?php echo $product_id; ?>" class="select-item me-2" <?php echo isset($_SESSION['selected_items'][$product_id]) ? 'checked' : ''; ?>>

                                <img src="<?php echo $image_path; ?>" alt="<?php echo $product['product_name']; ?>" class="cart-item-image me-2">
                                ...
                                <div class="cart-item-actions d-flex align-items-center">
                                    <div class="quantity-selector me-3">
                                        <button type="button" class="btn-quantity decrease" onclick="changeQuantity('<?php echo $product_id; ?>', -1)">−</button>
                                        <input type="text" name="quantity[<?php echo $product_id; ?>]" id="quantity_<?php echo $product_id; ?>" value="<?php echo $product['quantity']; ?>" min="1" max="<?php echo $available_quantity; ?>" data-max="<?php echo $available_quantity; ?>" class="quantity-input text-center" readonly>
                                        <button type="button" class="btn-quantity increase" onclick="changeQuantity('<?php echo $product_id; ?>', 1)">+</button>
                                    </div>
